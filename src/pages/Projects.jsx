    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                ...
                <button onClick={() => setIsDialogOpen(true)} className="flex items-center px-5 py-2 text-sm rounded bg-gradient-to-br from-slate-500 to-slate-600 text-white hover:opacity-90 transition" >
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative w-full max-w-sm">
                    ...
                    <input onChange={(e) => setSearchTerm(e.target.value)} value={searchTerm} className="w-full pl-10 text-sm pr-4 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 focus:border-slate-500 outline-none" placeholder="Search projects..." />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProjects.length === 0 ? (
                    <div className="col-span-full text-center py-16">
                        ...
                        <button onClick={() => setIsDialogOpen(true)} className="flex items-center gap-1.5 bg-slate-500 hover:bg-slate-600 text-white px-4 py-2 rounded mx-auto text-sm" >
