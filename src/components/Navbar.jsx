                ...
                <div className="flex items-center gap-4 min-w-0 flex-1">
                    ...
                    <div className="relative flex-1 max-w-sm">
                        ...
                        <input
                            ...
                            className="pl-8 pr-4 py-2 w-full bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 rounded-md text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-slate-500 transition"
                        />
                    </div>
                </div>
