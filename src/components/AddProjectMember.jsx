...
const AddProjectMember = ({ isDialogOpen, setIsDialogOpen, onInvite}) => {
                ...
                <div className="mb-4">
                    ...
                    {currentWorkspace && (
                        <p className="text-sm text-zinc-700 dark:text-zinc-400">
                            Adding to Project: <span className="text-slate-600 dark:text-slate-400">{project.name}</span>
                        </p>
                    )}
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <select value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 mt-1 w-full rounded border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-200 text-sm placeholder-zinc-400 dark:placeholder-zinc-500 py-2 focus:outline-none focus:border-slate-500" required >
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={isAdding || !currentWorkspace} className="px-5 py-2 text-sm rounded bg-gradient-to-br from-slate-500 to-slate-600 hover:opacity-90 text-white disabled:opacity-50 transition" >
