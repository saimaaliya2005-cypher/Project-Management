...
const typeIcons = {
    ...
    FEATURE: { icon: Zap, color: "text-slate-600 dark:text-slate-400" },
...
const priorityTexts = {
    ...
    MEDIUM: { background: "bg-slate-100 dark:bg-slate-950", prioritycolor: "text-slate-600 dark:text-slate-400" },
